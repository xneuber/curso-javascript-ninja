(function (){
  ...
  */
  ...
  console.log( text.replace(/Manuel Marques de Sousa/g, 'Neuber Vieira de Castro'));
  ...
  */
  ...
  console.log( text.replace(/brasileiro/g, 'orizonense'));
  ...
  */
  ...
  console.log( text.replace (/(O Centauro de Luvas)/, function (caracters) { return caracters.toUpperCase()}));
  ...
  */
  ...
  function getMonthNumber (monthName) {
    ...
    return objectMonth[monthName];
  }
  function printMonth ( monthName ) {
